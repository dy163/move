<template>
  <div>
    <div id="month" ref="month" class="text" ></div>
  </div>
</template>

<script>
import echarts from "echarts";
import { klineMonth } from "@/api/stocktime";
